...
const ComboBox = ({label, data, selected, setSelected, setPage} : ComboBoxType) => {
    ...
    return (
        ...
        <div 
        className={`text-black relative text-[0.8rem] flex items-center justify-between gap-2 bg-white px-2 py-1 rounded-t-md ${!show && 'rounded-b-md'} border border-black hover:cursor-pointer mt-1 sm:mt-0`} 
